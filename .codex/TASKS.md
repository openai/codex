...
## Done
- [x] Refreshed `origin/main` and created isolated worktree/branch.
- [x] Initialized project context pack.
- [x] Removed proven-dead MCP/RMCP code and narrowed internal-only exports.
- [x] Removed dead apps/connectors types, methods, fields, tests, and suppressions.

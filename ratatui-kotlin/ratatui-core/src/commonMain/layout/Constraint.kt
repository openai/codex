...
class ConstraintTest {
    ...
    @Test
    fun testDefault() {
        assertEquals(Constraint.default(), Constraint.Percentage(100u))
    }

    @Test
    fun testToString() {
        assertEquals(Constraint.Percentage(50u).toString(), "Percentage(50)")
        assertEquals(Constraint.Ratio(1u, 2u).toString(), "Ratio(1, 2)")
        assertEquals(Constraint.Length(10u).toString(), "Length(10)")
        assertEquals(Constraint.Max(10u).toString(), "Max(10)")
        assertEquals(Constraint.Min(10u).toString(), "Min(10)")
    }

    @Test
    fun testFromLengths() {
        val expected = listOf(
            Constraint.Length(1u),
            Constraint.Length(2u),
            Constraint.Length(3u)
        )
        assertEquals(Constraint.fromLengths(listOf(1u.toUShort(), 2u.toUShort(), 3u.toUShort())), expected)
    }
    ...
    fun testFromRatios() {
        ...
        assertEquals(Constraint.fromRatios(listOf(Pair(1u, 4u), Pair(1u, 2u), Pair(1u, 4u))), expected)
    }

    @Test
    fun testFromPercentages() {
        val expected = listOf(
            Constraint.Percentage(25u),
            Constraint.Percentage(50u),
            Constraint.Percentage(25u)
        )
        assertEquals(Constraint.fromPercentages(listOf(25u.toUShort(), 50u.toUShort(), 25u.toUShort())), expected)
    }

    @Test
    fun testFromMaxes() {
        val expected = listOf(Constraint.Max(1u), Constraint.Max(2u), Constraint.Max(3u))
        assertEquals(Constraint.fromMaxes(listOf(1u.toUShort(), 2u.toUShort(), 3u.toUShort())), expected)
    }

    @Test
    fun testFromMins() {
        val expected = listOf(Constraint.Min(1u), Constraint.Min(2u), Constraint.Min(3u))
        assertEquals(Constraint.fromMins(listOf(1u.toUShort(), 2u.toUShort(), 3u.toUShort())), expected)
    }
    ...
    fun testFromFills() {
        ...
        assertEquals(Constraint.fromFills(listOf(1u.toUShort(), 2u.toUShort(), 3u.toUShort())), expected)
    }

    @Suppress("DEPRECATION")
    @Test
    fun testApply() {
        assertEquals(Constraint.Percentage(0u).apply(100u), 0u.toUShort())
        assertEquals(Constraint.Percentage(50u).apply(100u), 50u.toUShort())
        assertEquals(Constraint.Percentage(100u).apply(100u), 100u.toUShort())
        assertEquals(Constraint.Percentage(200u).apply(100u), 100u.toUShort())

        // 0/0 intentionally avoids a panic by returning 0.
        assertEquals(Constraint.Ratio(0u, 0u).apply(100u), 0u.toUShort())
        // 1/0 intentionally avoids a panic by returning 100% of the length.
        assertEquals(Constraint.Ratio(1u, 0u).apply(100u), 100u.toUShort())
        assertEquals(Constraint.Ratio(0u, 1u).apply(100u), 0u.toUShort())
        assertEquals(Constraint.Ratio(1u, 2u).apply(100u), 50u.toUShort())
        assertEquals(Constraint.Ratio(2u, 2u).apply(100u), 100u.toUShort())
        assertEquals(Constraint.Ratio(3u, 2u).apply(100u), 100u.toUShort())

        assertEquals(Constraint.Length(0u).apply(100u), 0u.toUShort())
        assertEquals(Constraint.Length(50u).apply(100u), 50u.toUShort())
        assertEquals(Constraint.Length(100u).apply(100u), 100u.toUShort())
        assertEquals(Constraint.Length(200u).apply(100u), 100u.toUShort())

        assertEquals(Constraint.Max(0u).apply(100u), 0u.toUShort())
        assertEquals(Constraint.Max(50u).apply(100u), 50u.toUShort())
        assertEquals(Constraint.Max(100u).apply(100u), 100u.toUShort())
        assertEquals(Constraint.Max(200u).apply(100u), 100u.toUShort())

        assertEquals(Constraint.Min(0u).apply(100u), 100u.toUShort())
        assertEquals(Constraint.Min(50u).apply(100u), 100u.toUShort())
        assertEquals(Constraint.Min(100u).apply(100u), 100u.toUShort())
        assertEquals(Constraint.Min(200u).apply(100u), 200u.toUShort())
    }
}

...
- Command: `sleep 0.4`
- Iterations: `1`
- Config: `/var/folders/wl/z8733y815nzg28yy0_1_lh7w0000gn/T/codex-perf-6n_70dfm/codex-home/config.toml`
...
|---|---:|---:|---:|---:|---:|
| latency_ms | 1038.040 | 1038.040 | 1038.040 | 1038.040 | 1038.040 |
| throughput_runs_per_sec | 0.9634 | 0.9634 | 0.9634 | n/a | n/a |
...
| involuntary_ctx_switches | 12.0 | 12.0 | 12.0 | n/a | n/a |
...
| Step | Mean | P50 | P95 |
|---|---:|---:|---:|
| build_cmd | 2.667 | 2.667 | 2.667 |
| spawn_proc | 9.391 | 9.391 | 9.391 |
| monitor_loop | 970.503 | 970.503 | 970.503 |
| communicate | 0.097 | 0.097 | 0.097 |
| parse_stats | 0.805 | 0.805 | 0.805 |

## Resource Budget (Normalized)

| Budget | Metric | Value |
|---|---|---:|
| time | build_cmd_share_pct | 0.26 |
| time | spawn_proc_share_pct | 0.90 |
| time | monitor_loop_share_pct | 93.49 |
| time | communicate_share_pct | 0.01 |
| time | parse_stats_share_pct | 0.08 |
| time | unaccounted_share_pct | 5.26 |

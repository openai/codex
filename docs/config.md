...
| `graphiti.enabled`                               | boolean                                                           | Enable Graphiti memory integration (default: false).                                                                            |
| `graphiti.consent`                               | boolean                                                           | Explicit consent gate for sending turns to Graphiti (default: false).                                                           |
| `graphiti.endpoint`                              | string                                                            | Graphiti REST base URL (e.g. `http://localhost:8000`).                                                                          |
| `graphiti.bearer_token_env_var`                  | string                                                            | Env var containing an auth bearer token (optional).                                                                             |
| `graphiti.group_id_strategy`                     | `raw` \| `hashed`                                                 | Group id strategy (default: `hashed`).                                                                                          |
| `graphiti.include_git_metadata`                  | boolean                                                           | Include git metadata in message `source_description` (default: false).                                                          |
| `graphiti.include_system_messages`               | boolean                                                           | Include one-time ownership/system episodes per group (default: false).                                                          |
| `graphiti.user_scope_key`                        | string                                                            | Stable per-user key for deriving the Global scope group id (optional; avoids cross-user sharing).                               |
| `graphiti.ingest_scopes`                         | array<`session` \| `workspace` \| `global`>                        | Scopes to ingest automatically (default: `["session","workspace"]`).                                                            |
| `graphiti.ingest.timeout_ms`                     | number                                                            | Timeout for `POST /messages` (default: 5000).                                                                                   |
| `graphiti.ingest.max_queue_size`                 | number                                                            | Max queued ingestion jobs (default: 256).                                                                                       |
| `graphiti.ingest.max_batch_size`                 | number                                                            | Max messages per `POST /messages` (default: 32).                                                                                |
| `graphiti.ingest.max_content_chars`              | number                                                            | Max chars per ingested message (default: 8000).                                                                                 |
| `graphiti.ingest.retry_max_attempts`             | number                                                            | Max retry attempts per job (default: 6).                                                                                        |
| `graphiti.ingest.retry_initial_backoff_ms`       | number                                                            | Initial backoff (default: 250).                                                                                                 |
| `graphiti.ingest.retry_max_backoff_ms`           | number                                                            | Max backoff (default: 5000).                                                                                                    |
| `graphiti.recall.enabled`                        | boolean                                                           | Enable recall and prompt injection (default: false).                                                                            |
| `graphiti.recall.scopes_mode`                    | `static` \| `auto`                                                | Recall scopes selection mode (default: `static`).                                                                               |
| `graphiti.recall.timeout_ms`                     | number                                                            | Timeout for `POST /search` (default: 750).                                                                                      |
| `graphiti.recall.max_facts`                      | number                                                            | Max facts requested from Graphiti (default: 10).                                                                                |
| `graphiti.recall.max_fact_chars`                 | number                                                            | Max chars per injected fact (default: 280).                                                                                     |
| `graphiti.recall.max_total_chars`                | number                                                            | Max total chars for injected memory section (default: 2000).                                                                    |
| `graphiti.recall.scopes`                         | array<`session` \| `workspace` \| `global`>                        | Scopes to query for recall (default: `["session","workspace"]`).                                                                |
| `graphiti.global.enabled`                        | boolean                                                           | Enable Global scope for promotion/recall (default: false).                                                                      |
| `graphiti.global.group_id`                       | string                                                            | Group id used for Global scope (default: `codex-global`).                                                                       |
| `graphiti.auto_promote.enabled`                  | boolean                                                           | Detect supported "Memory Directives" in user turns and enqueue extra episodes (default: false).                                 |

...
#[tokio::test]
async fn chat_client_uses_chat_completions_path_for_chat_wire() {
...
#[tokio::test]
async fn chat_client_uses_responses_path_for_responses_wire() {
    let state = RecordingState::default();
    let transport = RecordingTransport::new(state.clone());
...
#[tokio::test]
async fn responses_client_uses_responses_path_for_responses_wire() {
    let state = RecordingState::default();
    let transport = RecordingTransport::new(state.clone());
...
#[tokio::test]
async fn responses_client_uses_chat_path_for_chat_wire() {
    let state = RecordingState::default();
    let transport = RecordingTransport::new(state.clone());
...
#[tokio::test]
async fn streaming_client_adds_auth_headers() {
    let state = RecordingState::default();
    let transport = RecordingTransport::new(state.clone());
...
#[tokio::test]
async fn streaming_client_retries_on_transport_error() {

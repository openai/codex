...
mod tests {
    ...
    #[tokio::test]
    async fn connect_attaches_auth_and_observes_handshake_and_wrapped_error_headers() {
        ...
        let ApiError::Transport(TransportError::Http { status, .. }) = error else {
            panic!("expected transport HTTP error");
        };

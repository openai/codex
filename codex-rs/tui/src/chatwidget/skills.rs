...
use codex_app_server_client::legacy_core::TOOL_MENTION_SIGIL;
use codex_app_server_client::legacy_core::connectors::connector_mention_slug;
use codex_app_server_client::legacy_core::skills::model::SkillDependencies;
use codex_app_server_client::legacy_core::skills::model::SkillInterface;
use codex_app_server_client::legacy_core::skills::model::SkillMetadata;
use codex_app_server_client::legacy_core::skills::model::SkillToolDependency;

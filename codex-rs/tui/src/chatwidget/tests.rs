...
fn rate_limit_warnings_emit_thresholds() {
    ...
    warnings.extend(state.take_warnings(Some(80.0), Some(10079), Some(10.0), Some(299)));
    warnings.extend(state.take_warnings(Some(10.0), Some(10079), Some(95.0), Some(299)));

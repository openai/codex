...
impl ChatWidget {
    ...
    pub(super) fn on_task_complete(
        ...
        // Queued follow-up input and active goal continuation both start or
        // schedule the next turn immediately, so notifying at that boundary
        // would feel like a false "needs attention".

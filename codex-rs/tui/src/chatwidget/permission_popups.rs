...
impl ChatWidget {
    ...
    fn auto_review_denials_popup_params(&self, thread_id: ThreadId) -> SelectionViewParams {
            ...
            self.review
                ...
                .map(|event| {
                    ...
                    let denial_label = match event.denial_kind {
                        Some(GuardianDenialKind::Soft) => "Soft denial",
                        Some(GuardianDenialKind::Denial) => "Denial",
                        None => "Review failure",
                    };
        ...
        SelectionViewParams {
            ...
            subtitle: Some(
                "Select a soft denial to approve one retry. Denials require a safer alternative."
                    .to_string(),
            ),
            footer_hint: Some(standard_popup_hint_line()),
            items,

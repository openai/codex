...
mod tests {
    ...
    /// Reassembles the original text from the highlighted line spans.
    ...
    /// Collects trimmed tokens that were rendered with a dim modifier.
    ...
    /// Ensures operator tokens are styled as dim while commands remain normal.
    #[test]
    ...
    /// Ensures redirects and string literals are dimmed.
    #[test]
    ...
    /// Verifies that commands use the default style while strings are dimmed.
    #[test]
    ...
    /// Verifies heredoc body content is treated as a string highlight.
    #[test]

...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("chat", "Chat", "reasoning_down", "Lower the active reasoning level when possible."),
    action("chat", "Chat", "reasoning_up", "Raise the active reasoning level when possible."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("chat", "reasoning_down") => Some(&mut keymap.chat.reasoning_down),
        ("chat", "reasoning_up") => Some(&mut keymap.chat.reasoning_up),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("chat", "reasoning_down") => Some(runtime_keymap.chat.reasoning_down.as_slice()),
        ("chat", "reasoning_up") => Some(runtime_keymap.chat.reasoning_up.as_slice()),

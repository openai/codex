...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("global", "Global", "toggle_sidebar", "Show or hide the owned-screen sidebar."),
    action("global", "Global", "toggle_summary", "Show or hide the owned-screen summary rail."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("global", "toggle_sidebar") => Some(&mut keymap.global.toggle_sidebar),
        ("global", "toggle_summary") => Some(&mut keymap.global.toggle_summary),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("global", "toggle_sidebar") => Some(runtime_keymap.app.toggle_sidebar.as_slice()),
        ("global", "toggle_summary") => Some(runtime_keymap.app.toggle_summary.as_slice()),

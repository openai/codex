...
pub(crate) struct ChatComposer {
    ...
    timer_scheduler_command_enabled: bool,
...
impl ChatComposer {
    fn builtin_command_flags(&self) -> BuiltinCommandFlags {
        BuiltinCommandFlags {
            ...
            timer_scheduler_command_enabled: self.timer_scheduler_command_enabled,
    ...
    pub(crate) fn new_with_config(
        ...
        let mut this = Self {
            ...
            timer_scheduler_command_enabled: false,
    ...
    pub fn set_timer_scheduler_command_enabled(&mut self, enabled: bool) {
        self.timer_scheduler_command_enabled = enabled;
    }
        ...
        match &mut self.active_popup {
            ...
            _ => {
                if is_editing_slash_command_name {
                    ...
                    let timer_scheduler_command_enabled = self.timer_scheduler_command_enabled;
                    ...
                    let mut command_popup = CommandPopup::new(CommandPopupFlags {
                        ...
                        timer_scheduler_command_enabled,

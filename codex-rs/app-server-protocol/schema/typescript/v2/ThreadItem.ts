...
import type { PendingToolCallStatus } from "./PendingToolCallStatus";
import type { ToolCallPayloadKind } from "./ToolCallPayloadKind";
import type { UserInput } from "./UserInput";
import type { WebSearchAction } from "./WebSearchAction";

export type ThreadItem = { "type": "userMessage", id: string, content: Array<UserInput>, } | { "type": "hookPrompt", id: string, fragments: Array<HookPromptFragment>, } | { "type": "agentMessage", id: string, text: string, phase: MessagePhase | null, memoryCitation: MemoryCitation | null, } | { "type": "plan", id: string, text: string, } | { "type": "reasoning", id: string, summary: Array<string>, content: Array<string>, } | { "type": "pendingToolCall", id: string, kind: ToolCallPayloadKind, label: string, payload: string, status: PendingToolCallStatus, } | { "type": "commandExecution", id: string, 
/**

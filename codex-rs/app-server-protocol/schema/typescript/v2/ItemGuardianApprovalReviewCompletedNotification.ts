...
import type { GuardianApprovalReviewDecisionSource } from "./GuardianApprovalReviewDecisionSource";
 ...
 */
export type ItemGuardianApprovalReviewCompletedNotification = { threadId: string, turnId: string, reviewId: string, targetItemId: string | null, decisionSource: GuardianApprovalReviewDecisionSource, review: GuardianApprovalReview, action: GuardianApprovalReviewAction, };

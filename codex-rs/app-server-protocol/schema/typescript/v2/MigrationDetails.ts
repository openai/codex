...
import type { MemoryFileMigration } from "./MemoryFileMigration";
...
export type MigrationDetails = { plugins: Array<PluginsMigration>, skills: Array<SkillMigration>, sessions: Array<SessionMigration>, mcpServers: Array<McpServerMigration>, hooks: Array<HookMigration>, subagents: Array<SubagentMigration>, commands: Array<CommandMigration>, memoryFiles: Array<MemoryFileMigration>, };

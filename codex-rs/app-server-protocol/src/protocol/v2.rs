...
use codex_protocol::ask_user_question::AskUserQuestionRequest as CoreAskUserQuestionRequest;
...
pub struct ThreadRewindParams {
    pub thread_id: String,
    /// 1-based index of the user message turn to rewind to.
    /// The target turn is removed from history; the thread is left positioned just before it.
    pub turn_index: u32,
    pub scope: ThreadRewindScope,
}
...
pub struct ThreadRewindResponse {
    /// Optional commit id restored when scope includes code.
...
pub struct AgentsListParams {
    ...
    /// When true, bypass any server-side caches and re-scan agents from disk.
    #[serde(default, skip_serializing_if = "std::ops::Not::not")]
    pub force_reload: bool,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct AgentsListEntry {
    pub cwd: PathBuf,
    pub agents: Vec<AgentMetadata>,
    pub errors: Vec<AgentErrorInfo>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct UndoStartedNotification {
    pub thread_id: String,
    pub turn_id: String,
    pub message: Option<String>,
}
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct UndoCompletedNotification {
    pub thread_id: String,
    pub turn_id: String,
    pub success: bool,
    pub message: Option<String>,
...
pub struct AskUserQuestionParams {
    ...
    pub turn_id: String,
    pub call_id: String,
    pub request: CoreAskUserQuestionRequest,
}

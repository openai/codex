...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadPurgeResult {
    pub thread_id: String,
    pub status: ThreadPurgeStatus,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ThreadPurgeResponse {
    pub data: Vec<ThreadPurgeResult>,
}

...
#[test]
fn sandbox_policy_rejects_legacy_workspace_write_writable_roots_field() {
    ...
    .expect_err("workspace-write policy should reject removed writableRoots field");
    assert!(err.to_string().contains("workspaceWrite.writableRoots"));
}

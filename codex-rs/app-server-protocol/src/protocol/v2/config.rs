...
pub enum ConfigLayerSource {
    ...
    /// In-memory config supplied by the host for the current process.
    InMemory,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ConfigInMemorySetParams {
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ConfigInMemorySetResponse {}

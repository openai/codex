    ...
    fn serialize_thread_realtime_start() -> Result<()> {
        let request = ClientRequest::ThreadRealtimeStart {
            ...
            params: v2::ThreadRealtimeStartParams {
                ...
                realtime_start_instructions: Some("Realtime started".to_string()),
                realtime_end_instructions: Some("Realtime ended".to_string()),
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "realtimeStartInstructions": "Realtime started",
                    "realtimeEndInstructions": "Realtime ended",

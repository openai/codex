...
server_notification_definitions! {
    ...
    #[experimental("thread/realtime/transcriptAdded")]
    ThreadRealtimeTranscriptAdded => "thread/realtime/transcriptAdded" (v2::ThreadRealtimeTranscriptAddedNotification),

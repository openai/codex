...
server_notification_definitions! {
    ...
    FileChangeInputStarted => "item/fileChange/inputStarted" (v2::FileChangeInputStartedNotification),
    FileChangeInputDelta => "item/fileChange/inputDelta" (v2::FileChangeInputDeltaNotification),

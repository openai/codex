...
pub struct DebugToml {
    /// Allow live catalog/session-derived values instead of storing them in the lock.
    pub allow_dynamic_catalog: Option<bool>,

    pub config_lock: Option<DebugConfigLockToml>,
}

...
If the goal has not been achieved and cannot continue productively, call update_goal with status "paused". Do not mark a goal complete merely because the budget is nearly exhausted or because you are stopping work.

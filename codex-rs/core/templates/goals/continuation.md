...
If the goal has not been achieved and cannot continue productively, leave the goal active and explain the blocker or next required input to the user. Do not call update_goal unless the goal is complete. Do not mark a goal complete merely because the budget is nearly exhausted or because you are stopping work.

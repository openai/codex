...
async fn normal_loop_context_window_error_auto_remote_compacts_and_resumes_turn() -> Result<()> {
    ...
    assert_eq!(
        responses[1]
            ...
            .count(),
        1,
        "recovered sampling request should preserve incoming user images exactly once"
    );
...
-> Result<()> {
    ...
    assert_eq!(
        responses[2]
            ...
            .count(),
        1,
        "recovered v2 sampling request should preserve incoming user text exactly once"
    );
    assert_eq!(
        responses[2]
            .message_input_image_urls("user")
            ...
            .count(),
        1,
        "recovered v2 sampling request should preserve incoming user images exactly once"
    );

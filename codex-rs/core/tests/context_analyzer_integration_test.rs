    ...
    let conversation = vec![
        ...
        ResponseItem::Message {
            ...
            content: vec![ContentItem::OutputText {
                text: "I'll help you check the weather. Let me search for current conditions."
                    .to_string(),
            }],
        },
    ];

    let breakdown = analyze_context(Some(system_prompt), &conversation, Some(tools_definition));
...
fn test_analyze_context_with_all_response_types() {
    ...
    use codex_protocol::models::{
        ContentItem, CustomToolCall, CustomToolCallOutput, FunctionCallOutputPayload,
        LocalShellAction, ReasoningItemContent, ReasoningItemReasoningSummary, ResponseItem,
        WebSearchAction,
    };
...
fn test_cross_crate_usage() {
    ...
    // Use analyze_context
    let result =
        context_analyzer::analyze_context(Some("System prompt"), &[], Some("Tools definition"));

...
pub(crate) type WindowsSandboxFilesystemOverrides =
    codex_windows_sandbox::WindowsSandboxFilesystemOverrides;
...
fn permission_profile_supports_windows_restricted_token_sandbox(
    ...
    codex_windows_sandbox::permission_profile_supports_windows_restricted_token_sandbox(
        permission_profile,
    )
}
...
pub(crate) fn resolve_windows_restricted_token_filesystem_overrides(
    ...
    codex_windows_sandbox::resolve_windows_restricted_token_filesystem_overrides(
...
pub(crate) fn resolve_windows_elevated_filesystem_overrides(
    ...
    codex_windows_sandbox::resolve_windows_elevated_filesystem_overrides(
        sandbox == SandboxType::WindowsRestrictedToken,
        permission_profile,
        sandbox_policy_cwd,
        use_windows_elevated_backend,
...
pub(crate) fn unsupported_windows_restricted_token_sandbox_reason(
    ...
    codex_windows_sandbox::unsupported_windows_restricted_token_sandbox_reason(
        sandbox == SandboxType::WindowsRestrictedToken,
        permission_profile,
        sandbox_policy_cwd,
        windows_sandbox_level,

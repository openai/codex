...
mod tests {
    ...
    async fn skills_are_appended_to_project_doc() {
        ...
        let usage_rules = r#"- Discovery: The list above is the skills available in this session (name + description + file path). Skill bodies live on disk at the listed paths.

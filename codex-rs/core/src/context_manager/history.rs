...
mod tests {
    ...
    fn truncated_message_pattern(line: &str, total_lines: usize) -> String {
        ...
        let tail_take =
            truncate::MODEL_FORMAT_TAIL_LINES.min(total_lines.saturating_sub(head_take));
        ...
        let item = ResponseItem::FunctionCallOutput {
            ...
            output: FunctionCallOutputPayload {
                ...
                content_items: Some(vec![
                    codex_protocol::models::FunctionCallOutputContentItem::InputText { text: t1 },
                    codex_protocol::models::FunctionCallOutputContentItem::InputText { text: t2 },
                    codex_protocol::models::FunctionCallOutputContentItem::InputImage {
                        image_url: "img:mid".to_string(),
                    },
                    codex_protocol::models::FunctionCallOutputContentItem::InputText { text: t3 },
                    codex_protocol::models::FunctionCallOutputContentItem::InputText { text: t4 },
                    codex_protocol::models::FunctionCallOutputContentItem::InputText { text: t5 },
                ]),
                success: Some(true),
            },
        };

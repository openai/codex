...
enum ShellCommandBackendConfig {
    Classic,
    ZshFork,
}
...
pub(crate) fn build_specs(
    ...
    let shell_command_handler = Arc::new(match config.shell_command_backend {
        ShellCommandBackendConfig::Classic => ShellCommandHandler::classic(),
        ShellCommandBackendConfig::ZshFork => ShellCommandHandler::zsh_fork(),
    });

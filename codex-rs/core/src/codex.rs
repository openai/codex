...
pub(crate) struct TurnContext {
    ...
    pub(crate) default_login_shell: bool,
...
impl TurnContext {
    ...
    pub(crate) async fn with_model(&self, model: String, models_manager: &ModelsManager) -> Self {
        ...
        Self {
            ...
            default_login_shell: self.default_login_shell,
            tools_config,
            features,
...
impl Session {
    ...
    fn make_turn_context(
        ...
        TurnContext {
            ...
            default_login_shell: per_turn_config.default_login_shell,
            tools_config,
...
async fn spawn_review_thread(
    ...
    let review_turn_context = TurnContext {
        ...
        default_login_shell: parent_turn_context.default_login_shell,

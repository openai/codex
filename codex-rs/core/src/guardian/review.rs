...
async fn run_guardian_review(
        ...
        .is_some_and(CancellationToken::is_cancelled)
    {
        analytics_context.track(
            ...
            GuardianReviewAnalyticsTerminal {
                ...
                ..GuardianReviewAnalyticsTerminal::from_session_metadata(None, now_unix_seconds())
            },
        );
        session
            .send_event(
    ...
    let terminal =
        |metadata| GuardianReviewAnalyticsTerminal::from_session_metadata(metadata, completed_at);

...
impl GuardianReviewAnalyticsTerminal {
    ...
    fn track(
        ...
        session
            ...
            .track_guardian_review(codex_analytics::GuardianReviewEventParams {
                ...
                outcome: terminal.outcome.map(analytics_guardian_assessment_outcome),
...
async fn run_guardian_review(
    ...
    let terminal =
        |metadata| GuardianReviewAnalyticsTerminal::from_metadata(metadata, completed_at);

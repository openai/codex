...
fn track_responses_api_call_attempt(
    ...
    sess.services
        ...
        .track_responses_api_call(
            ...
            attempt.into_input(status, error),
        );
}
    ...
    let outcome: CodexResult<SamplingRequestResult> = loop {
        ...
        match event {
            ...
            ResponseEvent::OutputItemDone(item) => {
                responses_api_call_attempt.record_output_item_done(&item);
            ...
            ResponseEvent::Completed {
                ...
                responses_api_call_attempt.record_completed(response_id, token_usage.clone());

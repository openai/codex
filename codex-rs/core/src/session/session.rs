...
pub(crate) struct Session {
    ...
    pub(crate) thread_goal_wall_clock_accounting: GoalWallClockAccountingState,
    pub(crate) goal_continuation_lock: Semaphore,
    pub(crate) goal_continuation_suppressed: AtomicBool,
...
impl Session {
    ...
    pub(crate) async fn new(
        ...
        let sess = Arc::new(Session {
            ...
            thread_goal_wall_clock_accounting: GoalWallClockAccountingState::new(),

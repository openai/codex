...
pub(crate) struct SessionConfiguration {
    ...
    pub(super) permission_profile_state: SessionPermissionProfileState,
...
#[derive(Clone)]
pub(super) struct SessionPermissionProfileState {
    ...
    /// Immutable workspace roots configured directly on the selected
    /// permissions profile.
    profile_workspace_roots: Vec<AbsolutePathBuf>,
}

impl SessionPermissionProfileState {
    pub(super) fn new(
        constrained_permission_profile: Constrained<PermissionProfile>,
        active_permission_profile: Option<ActivePermissionProfile>,
        profile_workspace_roots: Vec<AbsolutePathBuf>,
    ...
    fn constrained_permission_profile(&self) -> &Constrained<PermissionProfile> {
...
impl SessionConfiguration {
    ...
    pub(super) fn constrained_permission_profile(&self) -> &Constrained<PermissionProfile> {
    ...
    pub(super) fn apply_permission_profile_to_permissions(
        ...
        permissions.set_constrained_permission_profile_with_active_profile_and_workspace_roots(
            self.constrained_permission_profile().clone(),
    ...
    pub(super) fn set_permission_profile_for_tests(
        ...
        self.permission_profile_state.set_permission_profile(
            permission_profile,
        ...
        self.permission_profile()
            ...
            .unwrap_or_else(|_| {
                ...
                codex_sandboxing::compatibility_sandbox_policy_for_permission_profile(
                    self.constrained_permission_profile().get(),
                ...
                msg: EventMsg::SessionConfigured(SessionConfiguredEvent {
                    ...
                    network_proxy: session_network_proxy.filter(|_| {
                        Self::managed_network_proxy_active_for_permission_profile(
                            session_configuration.constrained_permission_profile().get(),
                        )
                    }),
                    rollout_path,
                }),

...
async fn test_list_conversations_latest_first() {
    ...
    let head_3 = vec![
        serde_json::json!({"timestamp": "2025-01-03T12-00-00", "type": "session_meta"}),
    ...
    let head_2 = vec![
        serde_json::json!({"timestamp": "2025-01-02T12-00-00", "type": "session_meta"}),
        serde_json::json!({"record_type": "response", "index": 0}),
        serde_json::json!({"record_type": "response", "index": 1}),
        serde_json::json!({"record_type": "response", "index": 2}),
    ];
    let head_1 = vec![
        serde_json::json!({"timestamp": "2025-01-01T12-00-00", "type": "session_meta"}),
        serde_json::json!({"record_type": "response", "index": 0}),
        serde_json::json!({"record_type": "response", "index": 1}),
        serde_json::json!({"record_type": "response", "index": 2}),
    ];
...
async fn test_pagination_cursor() {
    ...
    let head_5 = vec![
        serde_json::json!({"timestamp": "2025-03-05T09-00-00", "type": "session_meta"}),
        serde_json::json!({"record_type": "response", "index": 0}),
    ];
    let head_4 = vec![
        serde_json::json!({"timestamp": "2025-03-04T09-00-00", "type": "session_meta"}),
        serde_json::json!({"record_type": "response", "index": 0}),
    ];
    ...
    let head_3 = vec![
        serde_json::json!({"timestamp": "2025-03-03T09-00-00", "type": "session_meta"}),
        serde_json::json!({"record_type": "response", "index": 0}),
    ];
    let head_2 = vec![
        serde_json::json!({"timestamp": "2025-03-02T09-00-00", "type": "session_meta"}),
        serde_json::json!({"record_type": "response", "index": 0}),
    ];
    ...
    let head_1 = vec![
        serde_json::json!({"timestamp": "2025-03-01T09-00-00", "type": "session_meta"}),
        serde_json::json!({"record_type": "response", "index": 0}),
    ];
...
async fn test_get_conversation_contents() {
    ...
    let expected_head = vec![
        serde_json::json!({"timestamp": ts, "type": "session_meta"}),
        serde_json::json!({"record_type": "response", "index": 0}),
        serde_json::json!({"record_type": "response", "index": 1}),
    ];
    ...
    let meta = serde_json::json!({"timestamp": ts, "type": "session_meta", "payload": {"id": uuid, "timestamp": ts}});
...
async fn test_stable_ordering_same_second_pagination() {
    ...
    let head = |_u: Uuid| -> Vec<serde_json::Value> {
        vec![serde_json::json!({
            "timestamp": ts,
            "type": "session_meta"
        })]

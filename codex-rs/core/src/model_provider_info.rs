...
pub struct ModelProviderInfo {
    ...
    ///
    /// This is useful for providers that expose non-OpenAI model names (for example
    /// Azure AI Foundry deployments) and do not provide Codex-native model metadata.

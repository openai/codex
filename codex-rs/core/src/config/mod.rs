...
"#;
    ...
    fn test_requirements_web_search_mode_allowlist_does_not_warn_when_unset() -> anyhow::Result<()>
    {
        ...
        let mut requirements = crate::config_loader::ConfigRequirements::default();
        requirements.web_search_mode =
            crate::config_loader::ConstrainedWithSource::new(constrained, Some(requirement_source));
...
"#,
        ...
        assert_eq!(config.web_search_mode.value(), Some(WebSearchMode::Cached));
        assert_eq!(

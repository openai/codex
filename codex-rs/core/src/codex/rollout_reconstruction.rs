...
impl Session {
    pub(super) async fn reconstruct_history_from_rollout(
        ...
        reconstruct_history_from_rollout_items(rollout_items, turn_context.truncation_policy)
    }
}

pub(crate) fn reconstructed_history_from_rollout_items(
    rollout_items: &[RolloutItem],
    truncation_policy: TruncationPolicy,
) -> Vec<ResponseItem> {
    reconstruct_history_from_rollout_items(rollout_items, truncation_policy).history
}

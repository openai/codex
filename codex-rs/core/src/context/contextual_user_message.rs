...
use super::NextPromptSuggestionInstructions;
...
> = FragmentRegistrationProxy::new();
static NEXT_PROMPT_SUGGESTION_INSTRUCTIONS_REGISTRATION: FragmentRegistrationProxy<
...
static CONTEXTUAL_USER_FRAGMENTS: &[&dyn FragmentRegistration] = &[
    ...
    &NEXT_PROMPT_SUGGESTION_INSTRUCTIONS_REGISTRATION,
];

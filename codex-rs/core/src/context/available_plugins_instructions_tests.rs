...
#[test]
fn available_plugins_instructions_returns_none_for_empty_plugins() {
    assert_eq!(AvailablePluginsInstructions::from_plugins(&[]), None);
}

#[test]
fn available_plugins_instructions_includes_descriptions_and_skill_naming_guidance() {

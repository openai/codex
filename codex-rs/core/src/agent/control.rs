...
mod tests;
// Keep fork-reference coverage in current package tests; this inline module is stale after
// the current main API changes in ThreadManager and SubAgentSource.
#[cfg(any())]

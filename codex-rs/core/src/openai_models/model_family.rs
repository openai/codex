...
fn gpt_5_2_codex_family(slug: &str) -> ModelFamily {
...
fn bengalfox_family(slug: &str) -> ModelFamily {
    // Same as gpt-5.1-codex-max.
    model_family!(
        slug, slug,
        supports_reasoning_summaries: true,
...
fn gpt_5_2_family(slug: &str) -> ModelFamily {
    model_family!(
        slug, slug,
        supports_reasoning_summaries: true,
        apply_patch_tool_type: Some(ApplyPatchToolType::Freeform),
...
fn boomslang_family(slug: &str) -> ModelFamily {
    model_family!(
        slug, slug,
        supports_reasoning_summaries: true,
        apply_patch_tool_type: Some(ApplyPatchToolType::Freeform),
...
pub(super) fn find_family_for_model(slug: &str) -> ModelFamily {
    ...
    // Production models.
        ...
        gpt_5_2_codex_family(slug)
    } else if slug.starts_with("bengalfox") {
        bengalfox_family(slug)

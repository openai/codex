...
pub(crate) struct SessionServices {
    ...
    /// Candidate manager being validated before an atomic runtime snapshot publication.
    pub(crate) pending_mcp_connection_manager: ArcSwapOption<McpConnectionManager>,

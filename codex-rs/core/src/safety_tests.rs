...
fn permission_profile_for_policy(
...
fn external_sandbox_auto_approves_in_on_request() {
    ...
    assert_eq!(
        assess_patch_safety(
            ...
            &permission_profile_for_policy(&policy, &cwd),
...
fn granular_with_all_flags_true_matches_on_request_for_out_of_root_patch() {
    ...
    assert_eq!(
        assess_patch_safety(
            &add_outside,
            AskForApproval::OnRequest,
            &permission_profile_for_policy(&policy_workspace_only, &cwd),
            &FileSystemSandboxPolicy::from(&policy_workspace_only),
            &cwd,
            WindowsSandboxLevel::Disabled,
        ),
...
fn read_only_policy_rejects_patch_with_read_only_reason() {
    ...
    assert_eq!(
        assess_patch_safety(
            ...
            &permission_profile_for_policy(&sandbox_policy, &cwd),
            &file_system_sandbox_policy,
            &cwd,
            WindowsSandboxLevel::Disabled,
        ),

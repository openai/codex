...
impl ToolPluginProvenance {
    pub(crate) fn plugin_display_names_for_connector_id(&self, connector_id: &str) -> &[String] {
    ...
    pub(crate) fn plugin_display_names_for_mcp_server_name(&self, server_name: &str) -> &[String] {

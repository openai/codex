...
struct ResumeCommand {
    ...
    /// Show all recorded sessions instead of filtering to the current directory.
    #[arg(long = "all", default_value_t = false, conflicts_with = "session_id")]
    all: bool,

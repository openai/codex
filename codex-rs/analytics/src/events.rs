...
pub(crate) struct CodexTurnEventParams {
    ...
    pub(crate) between_sampling_post_response_ms: u64,
    pub(crate) between_sampling_retry_ms: u64,
    pub(crate) between_sampling_compaction_ms: u64,
    pub(crate) between_sampling_follow_up_ms: u64,
    pub(crate) between_sampling_request_preparation_ms: u64,
    pub(crate) between_sampling_other_ms: u64,

...
fn non_steerable_review_error_type() -> AnalyticsJsonRpcError {
    AnalyticsJsonRpcError::TurnSteer(TurnSteerRequestError::ActiveTurnNotSteerable {
        turn_kind: NonSteerableTurnKind::Review,
    })
}
    ...
    reducer
        .ingest(
            AnalyticsFact::ErrorResponse {
                ...
                error_type: Some(non_steerable_review_error_type()),
            },
            &mut out,
        )
        .await;
    ...
    reducer
        .ingest(
            AnalyticsFact::ErrorResponse {
                ...
                error_type: Some(input_too_large_error_type()),
            },
            &mut out,
        )
        .await;

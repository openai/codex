...
fn sample_turn_profile() -> TurnProfile {
    TurnProfile {
        ...
        between_sampling_post_response_ms: 10,
        between_sampling_retry_ms: 10,
        between_sampling_compaction_ms: 10,
        between_sampling_follow_up_ms: 10,
        between_sampling_request_preparation_ms: 5,
        between_sampling_other_ms: 5,

...
fn rejection_reason_from_error_type(
    ...
    match error_type {
        ...
        Some(AnalyticsJsonRpcError::TurnSteer(TurnSteerRequestError::NonSteerableReview)) => {
            Some(TurnSteerRejectionReason::NonSteerableReview)
        }
        Some(AnalyticsJsonRpcError::TurnSteer(TurnSteerRequestError::NonSteerableCompact)) => {
            Some(TurnSteerRejectionReason::NonSteerableCompact)
        }

...
use crate::events::ThreadLifecycleMetadata;
...
impl AnalyticsReducer {
    ...
    fn emit_thread_initialized(
        ...
        let thread_metadata =
            ThreadMetadataState::from_thread_lifecycle(&thread_source, initialization_mode);

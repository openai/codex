...
Keep the archive and binding file aligned to the exact resolved `v8` crate version in
`codex-rs/Cargo.lock`. Non-musl Bazel targets are left to the crate's default build-script
behavior.

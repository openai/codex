...
pub(crate) async fn exchange_code_for_tokens(
    ...
    Ok(ExchangedTokens {
        ...
        state: crate::http_state::resolve_token_response_state(tokens.state, tokens.oai_is),
    })
}
...
pub(crate) async fn persist_tokens_async(
    ...
    let (previous_auth, auth) = tokio::task::spawn_blocking(move || {
        ...
        crate::http_state::clear_before_login(&auth_codex_home);
    ...
    crate::http_state::store_after_login(&codex_home, http_state_surface, state);

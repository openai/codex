...
use codex_agent_identity::agent_identity_base_url_from_chatgpt_base_url;
...
impl CodexAuth {
    ...
    pub fn set_agent_identity(&self, record: AgentIdentityAuthRecord) -> std::io::Result<()> {
        ...
        match self {
            ...
            Self::ApiKey(_) | Self::AgentIdentity(_) | Self::PersonalAccessToken(_) => Ok(()),
        }?;
    ...
    pub fn remove_agent_identity(&self) -> std::io::Result<bool> {
        let removed = match self {
            ...
            Self::ApiKey(_) | Self::AgentIdentity(_) | Self::PersonalAccessToken(_) => Ok(false),
        }?;
        if removed {
    ...
    async fn ensure_chatgpt_agent_identity(
        ...
        let base_url = agent_identity_base_url_from_chatgpt_base_url(
            chatgpt_base_url
                .as_deref()
                .unwrap_or(DEFAULT_CHATGPT_BACKEND_BASE_URL),
        );

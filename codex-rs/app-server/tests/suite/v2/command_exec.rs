...
async fn command_exec_accepts_permission_profile() -> Result<()> {
    ...
    let command_request_id = mcp
        .send_command_exec_request(CommandExecParams {
            ...
            size: None,
            sandbox_policy: None,
            permission_profile: Some(active_permission_profile(
...
"#,
    ...
    let command_request_id = mcp
        .send_command_exec_request(CommandExecParams {
            ...
            size: None,
            sandbox_policy: None,
            permission_profile: Some(active_permission_profile("command-cwd")),
        })
        .await?;
...
fn active_permission_profile(id: &str) -> ActivePermissionProfile {

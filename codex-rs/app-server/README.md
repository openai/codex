...
- `thread/subagents/list` — experimental; page through a thread's direct persisted subagent children. Supports an optional durable spawn-edge `lifecycleStatuses` filter.

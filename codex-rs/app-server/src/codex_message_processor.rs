            ...
            loop {
                tokio::select! {
                    ...
                    event = conversation.next_event() => {
                        ...
                        let (raw_events_enabled, completed_turn) = {
                            let mut thread_state = thread_state.lock().await;
                            let completed_turn = thread_state.track_current_turn_event(&event.msg);
                            (thread_state.experimental_raw_events, completed_turn)
                        };

# @span-io/bracket-responses-api-proxy

<p align="center"><code>npm i -g @span-io/bracket-responses-api-proxy</code> to install <code>codex-responses-api-proxy</code></p>

...
/// While we want to deploy Codexel as a single executable for simplicity,
...
///
/// 1.  Load `.env` values from `~/.codexel/.env` before creating any threads.
...
/// Load env vars from ~/.codexel/.env.
///

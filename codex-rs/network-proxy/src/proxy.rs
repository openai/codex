...
impl NetworkProxy {
    ...
    /// Removes the private key persisted by older managed MITM implementations.
    pub fn remove_legacy_mitm_ca_private_key() -> Result<()> {
        crate::certs::remove_legacy_managed_ca_private_key()
    }

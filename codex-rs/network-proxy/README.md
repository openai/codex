...
# The CA signing key remains in proxy memory. When MITM is active, spawned commands receive
# CA bundle env vars pointing at immutable public files under $CODEX_HOME/proxy/ so common HTTPS

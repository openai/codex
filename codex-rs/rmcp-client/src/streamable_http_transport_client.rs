...
#[derive(Clone)]
struct ReqwestStreamableHttpTransportClient {
...
impl StreamableHttpTransportClient {
    pub(crate) fn new(
        ...
        let backend: Arc<dyn StreamableHttpTransportBackend> = match transport_mode {
            StreamableHttpTransportMode::Local => Arc::new(ReqwestStreamableHttpTransportClient {
...
trait StreamableHttpTransportBackend: Send + Sync {
    fn post_message(
        &self,
        uri: Arc<str>,
...
impl StreamableHttpTransportBackend for ReqwestStreamableHttpTransportClient {
    fn post_message(
        &self,
        uri: Arc<str>,
        message: rmcp::model::ClientJsonRpcMessage,

...
type Sanitized1003470703JSON struct {
	// Opaque pagination cursor returned by a previous call.
	Cursor *string `json:"cursor,omitempty"`
...
type Sanitized1028966912JSON struct {
	// Error corresponds to the JSON schema field "error".
...
type Sanitized1062900220JSON struct {
	// Enabled corresponds to the JSON schema field "enabled".
...
type Sanitized1173309102JSON struct {
	// Where to run the review: inline (default) on the current thread or detached on
	// a new thread (returned in `reviewThreadId`).
	Delivery interface{} `json:"delivery,omitempty"`

	// Target corresponds to the JSON schema field "target".
	Target Sanitized1173309102JSONTarget `json:"target"`

	// ThreadID corresponds to the JSON schema field "threadId".
	ThreadID string `json:"threadId"`
}

type Sanitized1173309102JSONTarget interface{}

type Sanitized1330262879JSON struct {
	// ApprovalPolicy corresponds to the JSON schema field "approvalPolicy".
	ApprovalPolicy interface{} `json:"approvalPolicy,omitempty"`
...
type Sanitized1337586211JSON struct {
	// ApiKey corresponds to the JSON schema field "apiKey".
	ApiKey string `json:"apiKey"`
}

type Sanitized1351872717JSON struct {
	// ThreadID corresponds to the JSON schema field "threadId".
	ThreadID string `json:"threadId"`
...
type Sanitized138813384JSON struct {
...
type Sanitized1388423235JSON struct {
	// ThreadID corresponds to the JSON schema field "threadId".
	ThreadID string `json:"threadId"`
...
type Sanitized1393730164JSON struct {
	// CancellationToken corresponds to the JSON schema field "cancellationToken".
	CancellationToken *string `json:"cancellationToken,omitempty"`
...
type Sanitized1456248309JSON struct {
	// Use to correlate this with [codex_core::protocol::ExecCommandBeginEvent] and
	// [codex_core::protocol::ExecCommandEndEvent].
	CallID string `json:"callId"`
	...
	// ParsedCmd corresponds to the JSON schema field "parsedCmd".
	ParsedCmd []Sanitized1456248309JSONParsedCmdElem `json:"parsedCmd"`

	// Reason corresponds to the JSON schema field "reason".
	Reason *string `json:"reason,omitempty"`
}

type Sanitized1456248309JSONParsedCmdElem interface{}

type Sanitized1581353102JSON struct {
	// ItemID corresponds to the JSON schema field "itemId".
	ItemID string `json:"itemId"`
...
type Sanitized1590506282JSON struct {
	// ConversationID corresponds to the JSON schema field "conversationId".
	ConversationID ThreadID `json:"conversationId"`
...
type Sanitized1674840415JSON struct {
	// Classification corresponds to the JSON schema field "classification".
	Classification string `json:"classification"`
...
type Sanitized1695209496JSON struct {
...
type Sanitized1700195560JSON struct {
...
type Sanitized170621320JSON struct {
...
type Sanitized1747631980JSON struct {
	// Name corresponds to the JSON schema field "name".
	Name string `json:"name"`
...
type Sanitized1752644887JSON struct {
	// Decision corresponds to the JSON schema field "decision".
	Decision Sanitized1752644887JSONDecision `json:"decision"`
}

type Sanitized1752644887JSONDecision interface{}

type Sanitized1760891287JSON struct {
	// UserAgent corresponds to the JSON schema field "userAgent".
	UserAgent string `json:"userAgent"`
}

type Sanitized1775128579JSON struct {
	// Cursor corresponds to the JSON schema field "cursor".
	Cursor *string `json:"cursor,omitempty"`
...
type Sanitized1845445957JSON struct {
	// Opaque pagination cursor returned by a previous call.
	Cursor *string `json:"cursor,omitempty"`
...
type Sanitized1919604392JSON struct {
	// Opaque pagination cursor returned by a previous call.
	Cursor *string `json:"cursor,omitempty"`
...
type Sanitized2041541100JSON struct {
	// Data corresponds to the JSON schema field "data".
	Data []Sanitized2041541100JSONDataElem `json:"data"`
}

type Sanitized2041541100JSONDataElem interface{}

type Sanitized2053120556JSON struct {
	// LoginID corresponds to the JSON schema field "loginId".
	LoginID string `json:"loginId"`
}

type Sanitized2055594514JSON struct {
	// ExpectedVersion corresponds to the JSON schema field "expectedVersion".
	ExpectedVersion *string `json:"expectedVersion,omitempty"`
...
type Sanitized2057229009JSON struct {
	// Delta corresponds to the JSON schema field "delta".
	Delta string `json:"delta"`
...
type Sanitized2063355288JSON struct {
	// ThreadID corresponds to the JSON schema field "threadId".
	ThreadID string `json:"threadId"`
}

type Sanitized2069908001JSON struct {
	// Opaque pagination cursor returned by a previous call.
	Cursor *string `json:"cursor,omitempty"`
...
type Sanitized2094073764JSON struct {
	// Item corresponds to the JSON schema field "item".
	Item Sanitized2094073764JSONItem `json:"item"`
...
type Sanitized2094073764JSONItem interface{}

type Sanitized209689204JSON struct {
	// Command corresponds to the JSON schema field "command".
	Command []string `json:"command"`
...
type Sanitized2138498814JSON struct {
	// [UNSTABLE] When set, the agent is asking the user to allow writes under this
	// root for the remainder of the session (unclear if this is honored today).
	GrantRoot *string `json:"grantRoot,omitempty"`
...
type Sanitized2150407558JSON struct {
...
type Sanitized2297000310JSON struct {
...
type Sanitized2315484939JSON struct {
	// UserAgent corresponds to the JSON schema field "userAgent".
	UserAgent string `json:"userAgent"`
}

type Sanitized2328339426JSON struct {
...
type Sanitized2341033347JSON struct {
...
type Sanitized2349533623JSON struct {
	// Config corresponds to the JSON schema field "config".
...
type Sanitized2381563952JSON struct {
	// ItemID corresponds to the JSON schema field "itemId".
	ItemID string `json:"itemId"`
...
type Sanitized2461346729JSON struct {
	// RefreshToken corresponds to the JSON schema field "refreshToken".
	RefreshToken bool `json:"refreshToken,omitempty"`
}

type Sanitized2462206422JSON struct {
	// RateLimits corresponds to the JSON schema field "rateLimits".
	RateLimits RateLimitSnapshot `json:"rateLimits"`
}

type Sanitized2479117276JSON struct {
	// IncludeToken corresponds to the JSON schema field "includeToken".
	IncludeToken *bool `json:"includeToken,omitempty"`
...
type Sanitized2509411582JSON struct {
	// ApprovalPolicy corresponds to the JSON schema field "approvalPolicy".
	ApprovalPolicy interface{} `json:"approvalPolicy,omitempty"`
	...
	History []Sanitized2509411582JSONHistoryElem `json:"history,omitempty"`
...
type Sanitized2509411582JSONHistoryElem interface{}

type Sanitized260577805JSON struct {
	// ConversationID corresponds to the JSON schema field "conversationId".
	ConversationID ThreadID `json:"conversationId"`
}

type Sanitized2645344512JSON struct {
	// Decision corresponds to the JSON schema field "decision".
	Decision Sanitized2645344512JSONDecision `json:"decision"`
}

type Sanitized2645344512JSONDecision interface{}

type Sanitized2742056492JSON struct {
	// Error corresponds to the JSON schema field "error".
	Error *string `json:"error,omitempty"`
...
type Sanitized2764264882JSON struct {
	// Data corresponds to the JSON schema field "data".
...
//
// Prefer using thread_id whenever possible.
type Sanitized276555956JSON struct {
	// ApprovalPolicy corresponds to the JSON schema field "approvalPolicy".
	ApprovalPolicy interface{} `json:"approvalPolicy,omitempty"`
...
type Sanitized2771888558JSON struct {
...
type Sanitized2907484385JSON struct {
	// Decision corresponds to the JSON schema field "decision".
	Decision Sanitized2907484385JSONDecision `json:"decision"`
}

type Sanitized2907484385JSONDecision interface{}

// EXPERIMENTAL. Response payload mapping question ids to answers.
type Sanitized2912408341JSON struct {
	// Answers corresponds to the JSON schema field "answers".
	Answers map[string]ToolRequestUserInputAnswer `json:"answers"`
}

type Sanitized294826068JSON struct {
...
type Sanitized3076916473JSON struct {
...
type Sanitized3097767966JSON struct {
	// ConversationID corresponds to the JSON schema field "conversationId".
	ConversationID ThreadID `json:"conversationId"`
...
type Sanitized3168743679JSON struct {
	// Edits corresponds to the JSON schema field "edits".
	Edits []ConfigEdit `json:"edits"`
...
type Sanitized3206434243JSON struct {
	// The command to be executed.
	Command *string `json:"command,omitempty"`

	// Best-effort parsed command actions for friendly display.
	CommandActions []Sanitized3206434243JSONCommandActionsElem `json:"commandActions,omitempty"`
...
type Sanitized3206434243JSONCommandActionsElem interface{}

type Sanitized3412194205JSON struct {
	// ClientInfo corresponds to the JSON schema field "clientInfo".
	ClientInfo ClientInfo `json:"clientInfo"`
}

type Sanitized3439411271JSON struct {
	// Delta corresponds to the JSON schema field "delta".
	Delta string `json:"delta"`
...
type Sanitized3450949743JSON struct {
...
type Sanitized3514746113JSON struct {
	// Diff corresponds to the JSON schema field "diff".
	Diff string `json:"diff"`
...
type Sanitized3544762052JSON struct {
	// ThreadID corresponds to the JSON schema field "threadId".
	ThreadID string `json:"threadId"`
}

type Sanitized3594266006JSON struct {
	// LoginID corresponds to the JSON schema field "loginId".
	LoginID string `json:"loginId"`
}

// EXPERIMENTAL. Params sent with a request_user_input event.
type Sanitized3627121135JSON struct {
	// ItemID corresponds to the JSON schema field "itemId".
	ItemID string `json:"itemId"`
...
type Sanitized3692175809JSON struct {
	// RateLimits corresponds to the JSON schema field "rateLimits".
	RateLimits RateLimitSnapshot `json:"rateLimits"`
}

type Sanitized3783030893JSON struct {
	// Null if no requirements are configured (e.g. no requirements.toml/MDM entries).
	Requirements interface{} `json:"requirements,omitempty"`
}

type Sanitized3791475556JSON struct {
...
type Sanitized3837900799JSON struct {
	// Delta corresponds to the JSON schema field "delta".
	Delta string `json:"delta"`
...
type Sanitized3844759102JSON struct {
	// AuthMode corresponds to the JSON schema field "authMode".
	AuthMode interface{} `json:"authMode,omitempty"`
}

type Sanitized3888927471JSON struct {
	// SubscriptionID corresponds to the JSON schema field "subscriptionId".
	SubscriptionID string `json:"subscriptionId"`
}

type Sanitized3954760238JSON struct {
	// Optional working directory to resolve project config layers. If specified,
	// return the effective config as seen from that directory (i.e., including any
	// project layers between `cwd` and the project/repo root).
	Cwd *string `json:"cwd,omitempty"`
...
type Sanitized3972435716JSON struct {
	// AuthMethod corresponds to the JSON schema field "authMethod".
	AuthMethod interface{} `json:"authMethod,omitempty"`
}

type Sanitized4063336740JSON struct {
	// Data corresponds to the JSON schema field "data".
...
type Sanitized409891963JSON struct {
	// Status corresponds to the JSON schema field "status".
	Status CancelLoginAccountStatus `json:"status"`
}

type Sanitized4178803831JSON struct {
	// Decision corresponds to the JSON schema field "decision".
	Decision Sanitized4178803831JSONDecision `json:"decision"`
}

type Sanitized4178803831JSONDecision interface{}

type Sanitized4194939665JSON struct {
	// Cwd corresponds to the JSON schema field "cwd".
	Cwd string `json:"cwd"`
}

type Sanitized445987687JSON struct {
	// ConversationID corresponds to the JSON schema field "conversationId".
	ConversationID ThreadID `json:"conversationId"`
...
type Sanitized536688165JSON struct {
	// ItemID corresponds to the JSON schema field "itemId".
	ItemID string `json:"itemId"`
...
type Sanitized578943615JSON struct {
...
type Sanitized581407936JSON struct {
	// EffectiveEnabled corresponds to the JSON schema field "effectiveEnabled".
	EffectiveEnabled bool `json:"effectiveEnabled"`
}

type Sanitized608333496JSON struct {
	// SubscriptionID corresponds to the JSON schema field "subscriptionId".
	SubscriptionID string `json:"subscriptionId"`
}

type Sanitized644739272JSON struct {
	// ThreadID corresponds to the JSON schema field "threadId".
	ThreadID string `json:"threadId"`
...
type Sanitized678159969JSON struct {
	// Error corresponds to the JSON schema field "error".
	Error *string `json:"error,omitempty"`
...
type Sanitized683313941JSON struct {
	// Error corresponds to the JSON schema field "error".
	Error *string `json:"error,omitempty"`
...
type Sanitized833319130JSON struct {
	// Delta corresponds to the JSON schema field "delta".
	Delta string `json:"delta"`
...
type Sanitized878065350JSON struct {
	// ExitCode corresponds to the JSON schema field "exitCode".
	ExitCode int `json:"exitCode"`
...
type Sanitized896296688JSON struct {
	// Model corresponds to the JSON schema field "model".
	Model *string `json:"model,omitempty"`

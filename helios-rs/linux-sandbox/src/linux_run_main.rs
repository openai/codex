...
pub struct LandlockCommand {
    ...
    pub sandbox_policy: helios_protocol::protocol::SandboxPolicy,
...
fn run_bwrap_with_proc_fallback(
    ...
    sandbox_policy: &helios_protocol::protocol::SandboxPolicy,
    inner: Vec<String>,
    mount_proc: bool,
    ...
    {
        eprintln!("helios-linux-sandbox: bwrap could not mount /proc; retrying with --no-proc");
        mount_proc = false;
    }
...
fn build_bwrap_argv(
    ...
    args.splice(
        ...
        ["--argv0".to_string(), "helios-linux-sandbox".to_string()],
    );

...
use helios_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use helios_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use helios_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
...
use helios_protocol::config_types::SandboxMode as CoreSandboxMode;
use helios_protocol::config_types::Verbosity;
use helios_protocol::config_types::WebSearchMode;
use helios_protocol::items::AgentMessageContent as CoreAgentMessageContent;
use helios_protocol::items::TurnItem as CoreTurnItem;
use helios_protocol::mcp::Resource as McpResource;
use helios_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use helios_protocol::mcp::Tool as McpTool;
...
use helios_protocol::parse_command::ParsedCommand as CoreParsedCommand;
use helios_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use helios_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use helios_protocol::protocol::AgentStatus as CoreAgentStatus;
use helios_protocol::protocol::AskForApproval as CoreAskForApproval;
use helios_protocol::protocol::CodexErrorInfo as CoreCodexErrorInfo;
use helios_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use helios_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
use helios_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use helios_protocol::protocol::NetworkAccess as CoreNetworkAccess;
use helios_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use helios_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use helios_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use helios_protocol::protocol::ReadOnlyAccess as CoreReadOnlyAccess;
use helios_protocol::protocol::RejectConfig as CoreRejectConfig;
use helios_protocol::protocol::SessionSource as CoreSessionSource;
use helios_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use helios_protocol::protocol::SkillErrorInfo as CoreSkillErrorInfo;
use helios_protocol::protocol::SkillInterface as CoreSkillInterface;
use helios_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use helios_protocol::protocol::SkillScope as CoreSkillScope;
use helios_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
use helios_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use helios_protocol::protocol::TokenUsage as CoreTokenUsage;
use helios_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
use helios_protocol::user_input::ByteRange as CoreByteRange;
use helios_protocol::user_input::TextElement as CoreTextElement;
use helios_protocol::user_input::UserInput as CoreUserInput;
...
v2_enum_from_core!(
    pub enum ReviewDelivery from helios_protocol::protocol::ReviewDelivery {
        Inline, Detached
    }
);

v2_enum_from_core!(
    pub enum McpAuthStatus from helios_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
pub enum ConfigLayerSource {
    ...
    /// User config layer from $HELIOS_HOME/config.toml. This layer is special
    ...
    #[ts(rename_all = "camelCase")]
    Project {
        dot_helios_folder: AbsolutePathBuf,
    },
...
impl SandboxPolicy {
    pub fn to_core(&self) -> helios_protocol::protocol::SandboxPolicy {
        match self {
            SandboxPolicy::DangerFullAccess => {
                helios_protocol::protocol::SandboxPolicy::DangerFullAccess
            }
            SandboxPolicy::ReadOnly { access } => {
                helios_protocol::protocol::SandboxPolicy::ReadOnly {
                    access: access.to_core(),
                }
            }
            SandboxPolicy::ExternalSandbox { network_access } => {
                helios_protocol::protocol::SandboxPolicy::ExternalSandbox {
            ...
            SandboxPolicy::WorkspaceWrite {
                ...
                exclude_slash_tmp,
            } => helios_protocol::protocol::SandboxPolicy::WorkspaceWrite {
...
impl From<helios_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: helios_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            helios_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            helios_protocol::protocol::SandboxPolicy::ReadOnly { access } => {
                SandboxPolicy::ReadOnly {
                    access: ReadOnlyAccess::from(access),
                }
            }
            helios_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR HELIOS CLOUD - DO NOT USE.
...
pub struct TurnError {
    pub message: String,
    pub helios_error_info: Option<CodexErrorInfo>,
    #[serde(default)]
...
impl From<helios_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: helios_protocol::models::WebSearchAction) -> Self {
        match value {
            helios_protocol::models::WebSearchAction::Search { query, queries } => {
                WebSearchAction::Search { query, queries }
            }
            helios_protocol::models::WebSearchAction::OpenPage { url } => {
                WebSearchAction::OpenPage { url }
            }
            helios_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
                WebSearchAction::FindInPage { url, pattern }
            }
            helios_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl From<DynamicToolCallOutputContentItem>
    for helios_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
...
mod tests {
    use super::*;
    use helios_protocol::items::AgentMessageContent;
    use helios_protocol::items::AgentMessageItem;
    use helios_protocol::items::ReasoningItem;
    use helios_protocol::items::TurnItem;
    use helios_protocol::items::UserMessageItem;
    use helios_protocol::items::WebSearchItem;
    use helios_protocol::models::WebSearchAction as CoreWebSearchAction;
    use helios_protocol::protocol::NetworkAccess as CoreNetworkAccess;
    use helios_protocol::protocol::ReadOnlyAccess as CoreReadOnlyAccess;
    use helios_protocol::user_input::UserInput as CoreUserInput;
    ...
    #[test]
    fn helios_error_info_serializes_http_status_code_in_camel_case() {

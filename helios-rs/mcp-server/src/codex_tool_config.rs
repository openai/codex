...
use helios_utils_json_to_toml::json_to_toml;
...
fn helios_tool_output_schema() -> Arc<JsonObject> {
...
impl CodexToolCallParam {
    ...
    pub async fn into_config(
        ...
        // Build the `ConfigOverrides` recognized by helios-core.
...
/// Builds a `Tool` definition for the `helios-reply` tool-call.
pub(crate) fn create_tool_for_helios_tool_call_reply_param() -> Tool {
    let schema = SchemaSettings::draft2019_09()
        .with(|s| {
            s.inline_subschemas = true;
            s.option_add_null_type = false;
...
mod tests {
    ...
    #[test]
    fn verify_helios_tool_json_schema() {
          ...
          "inputSchema": {
            "properties": {
              ...
              "config": {
                ...
                "description": "Individual config settings that will override what is in HELIOS_HOME/config.toml.",
                "type": "object"
              },
              "cwd": {
    ...
    #[test]
    fn verify_helios_tool_reply_json_schema() {

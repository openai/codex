...
#[cfg(target_os = "windows")]
pub use workspace_acl::protect_workspace_helios_dir;
...
mod windows_impl {
    ...
    use super::workspace_acl::protect_workspace_helios_dir;
    use anyhow::Result;
    ...
    pub fn run_windows_sandbox_capture(
        ...
        ensure_helios_home_exists(helios_home)?;
        ...
        let (h_token, psid_generic, psid_workspace): (HANDLE, *mut c_void, Option<*mut c_void>) = unsafe {
            match &policy {
                ...
                SandboxPolicy::WorkspaceWrite { .. } => {
                    ...
                    let ws_sid = workspace_cap_sid_for_cwd(helios_home, cwd)?;
        ...
        unsafe {
            ...
            if let Some(psid) = psid_workspace {
                ...
                let _ = protect_workspace_helios_dir(&current_dir, psid);
    ...
    pub fn run_windows_sandbox_legacy_preflight(
        ...
        unsafe {
            ...
            let _ = protect_workspace_helios_dir(&current_dir, psid_workspace);

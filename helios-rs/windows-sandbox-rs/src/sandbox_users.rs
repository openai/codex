...
use helios_windows_sandbox::dpapi_protect;
use helios_windows_sandbox::sandbox_dir;
use helios_windows_sandbox::sandbox_secrets_dir;
use helios_windows_sandbox::string_from_sid_bytes;
use helios_windows_sandbox::to_wide;
use helios_windows_sandbox::SetupErrorCode;
use helios_windows_sandbox::SetupFailure;
use helios_windows_sandbox::SETUP_VERSION;
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(helios_home);
    ...
    let secrets_dir = sandbox_secrets_dir(helios_home);

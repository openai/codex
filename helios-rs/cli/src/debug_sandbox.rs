...
use helios_core::landlock::spawn_command_under_linux_sandbox;
#[cfg(target_os = "macos")]
use helios_core::seatbelt::spawn_command_under_seatbelt;
use helios_core::spawn::StdioPolicy;
use helios_protocol::config_types::SandboxMode;
...
pub async fn run_command_under_seatbelt(
    ...
    _helios_linux_sandbox_exe: Option<PathBuf>,
) -> anyhow::Result<()> {
...
async fn run_command_under_sandbox(
    ...
    if let SandboxType::Windows = sandbox_type {
        #[cfg(target_os = "windows")]
        {
            ...
            let base_dir = config.helios_home.clone();
    ...
    let network = network_proxy
        .as_ref()
        .map(helios_core::config::StartedNetworkProxy::proxy);
    ...
    let mut child = match sandbox_type {
        ...
        SandboxType::Landlock => {
            ...
            let helios_linux_sandbox_exe = config
                .helios_linux_sandbox_exe
                .expect("helios-linux-sandbox executable not found");

...
pub async fn run_login_status(cli_config_overrides: CliConfigOverrides) -> ! {
    ...
    match CodexAuth::from_auth_storage(&config.helios_home, config.cli_auth_credentials_store_mode) {
...
pub async fn run_logout(cli_config_overrides: CliConfigOverrides) -> ! {
    ...
    match logout(&config.helios_home, config.cli_auth_credentials_store_mode) {
        Ok(true) => {

...
async fn list_and_get_render_expected_output() -> Result<()> {
    ...
    let mut add = helios_command(helios_home.path())?;
    add.args([
        "mcp",
        "add",
        "docs",
    ...
    let mut servers = load_global_mcp_servers(helios_home.path()).await?;
    ...
    let mut list_cmd = helios_command(helios_home.path())?;
    ...
    let mut list_json_cmd = helios_command(helios_home.path())?;
    ...
    let mut get_cmd = helios_command(helios_home.path())?;
    ...
    let mut get_json_cmd = helios_command(helios_home.path())?;
    get_json_cmd

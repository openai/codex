use helios_app_server_protocol::DynamicToolCallResponse;
use helios_core::CodexThread;
use helios_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
use helios_protocol::dynamic_tools::DynamicToolResponse as CoreDynamicToolResponse;
...
pub(crate) async fn on_call_response(
    ...
    let response = serde_json::from_value::<DynamicToolCallResponse>(value).unwrap_or_else(|err| {
        ...
        DynamicToolCallResponse {
            content_items: vec![
                helios_app_server_protocol::DynamicToolCallOutputContentItem::InputText {

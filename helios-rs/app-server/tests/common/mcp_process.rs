...
use helios_app_server_protocol::CancelLoginChatGptParams;
...
pub const DEFAULT_CLIENT_NAME: &str = "helios-app-server-tests";
...
impl McpProcess {
    ...
    pub async fn new_with_env(
        ...
        let program = helios_utils_cargo_bin::cargo_bin("helios-app-server")
            .context("should find binary for helios-app-server")?;
        ...
        cmd.env_remove(HELIOS_INTERNAL_ORIGINATOR_OVERRIDE_ENV_VAR);
...
impl Drop for McpProcess {
    fn drop(&mut self) {
        // These tests spawn a `helios-app-server` child process.
        //

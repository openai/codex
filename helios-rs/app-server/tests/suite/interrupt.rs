...
use helios_app_server_protocol::InterruptConversationParams;
use helios_app_server_protocol::InterruptConversationResponse;
...
async fn shell_command_interruption() -> anyhow::Result<()> {
    ...
    let send_user_id = mcp
        .send_send_user_message_request(SendUserMessageParams {
            conversation_id,
            items: vec![helios_app_server_protocol::InputItem::Text {
...
fn create_config_toml(helios_home: &Path, server_uri: String) -> std::io::Result<()> {

...
use helios_app_server_protocol::Model;
use helios_app_server_protocol::ModelListParams;
use helios_app_server_protocol::ModelListResponse;
use helios_app_server_protocol::ReasoningEffortOption;
use helios_app_server_protocol::RequestId;
use helios_protocol::openai_models::InputModality;
...
async fn list_models_returns_all_models_with_large_limit() -> Result<()> {
    ...
    write_models_cache(helios_home.path())?;
    ...
    let expected_models = vec![
        ...
        Model {
            id: "gpt-5.1-helios-mini".to_string(),
            model: "gpt-5.1-helios-mini".to_string(),
            upgrade: Some("gpt-5.2-codex".to_string()),
            display_name: "gpt-5.1-helios-mini".to_string(),
...
async fn list_models_pagination_works() -> Result<()> {
    ...
    assert_eq!(second_items[0].id, "gpt-5.1-helios-max");
    ...
    assert_eq!(third_items[0].id, "gpt-5.1-helios-mini");

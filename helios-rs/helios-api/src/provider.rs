use helios_client::Request;
use helios_client::RequestCompression;
use helios_client::RetryOn;
use helios_client::RetryPolicy;
use http::Method;
...
///
/// This is converted into a `RetryPolicy` used by `helios-client` to drive

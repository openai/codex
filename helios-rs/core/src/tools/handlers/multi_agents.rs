...
use helios_protocol::protocol::CollabAgentInteractionBeginEvent;
use helios_protocol::protocol::CollabAgentInteractionEndEvent;
use helios_protocol::protocol::CollabAgentRef;
use helios_protocol::protocol::CollabAgentSpawnBeginEvent;
use helios_protocol::protocol::CollabAgentSpawnEndEvent;
use helios_protocol::protocol::CollabAgentStatusEntry;
use helios_protocol::protocol::CollabCloseBeginEvent;
use helios_protocol::protocol::CollabCloseEndEvent;
use helios_protocol::protocol::CollabResumeBeginEvent;
use helios_protocol::protocol::CollabResumeEndEvent;
use helios_protocol::protocol::CollabWaitingBeginEvent;
use helios_protocol::protocol::CollabWaitingEndEvent;
...
fn build_agent_shared_config(
    ...
    config.helios_linux_sandbox_exe = turn.helios_linux_sandbox_exe.clone();
...
mod tests {
    ...
    async fn spawn_agent_uses_explorer_role_and_sets_never_approval_policy() {
        ...
        let snapshot = manager
            ...
            .config_snapshot()
            .await;
        assert_eq!(snapshot.model, "gpt-5.1-helios-mini");
    ...
    async fn build_agent_spawn_config_uses_turn_context_values() {
        ...
        turn.helios_linux_sandbox_exe = Some(PathBuf::from("/bin/echo"));
        ...
        expected.helios_linux_sandbox_exe = turn.helios_linux_sandbox_exe.clone();

...
use helios_protocol::openai_models::ModelUpgrade;
use helios_protocol::openai_models::ReasoningEffort;
use helios_protocol::openai_models::ReasoningEffortPreset;
use helios_protocol::openai_models::default_input_modalities;
use indoc::indoc;
use once_cell::sync::Lazy;

pub const HIDE_GPT5_1_MIGRATION_PROMPT_CONFIG: &str = "hide_gpt5_1_migration_prompt";
pub const HIDE_GPT_5_1_HELIOS_MAX_MIGRATION_PROMPT_CONFIG: &str =
    "hide_gpt-5.1-helios-max_migration_prompt";
...
pub(crate) static PRESETS: Lazy<Vec<ModelPreset>> = Lazy::new(|| {
    vec![
        ...
        ModelPreset {
            ...
            is_default: false,
            upgrade: Some(gpt_52_helios_upgrade()),
            show_in_picker: true,
            supported_in_api: true,
            input_modalities: default_input_modalities(),
        },
        ...
        ModelPreset {
            id: "gpt-5-helios-mini".to_string(),
            model: "gpt-5-helios-mini".to_string(),
            display_name: "gpt-5-helios-mini".to_string(),
            description: "Optimized for codex. Cheaper, faster, but less capable.".to_string(),
            default_reasoning_effort: ReasoningEffort::Medium,
            supported_reasoning_efforts: vec![
                ReasoningEffortPreset {
...
fn gpt_52_helios_upgrade() -> ModelUpgrade {
    ModelUpgrade {
        id: "gpt-5.2-codex".to_string(),

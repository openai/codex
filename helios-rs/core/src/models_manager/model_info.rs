...
use helios_protocol::openai_models::ModelInstructionsVariables;
use helios_protocol::openai_models::ModelMessages;
use helios_protocol::openai_models::ModelVisibility;
use helios_protocol::openai_models::TruncationMode;
...
fn local_personality_messages_for_slug(slug: &str) -> Option<ModelMessages> {
    match slug {
        "gpt-5.2-codex" | "exp-helios-personality" => Some(ModelMessages {

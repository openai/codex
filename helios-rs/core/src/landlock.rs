...
/// (helios-linux-sandbox), which currently uses bubblewrap for filesystem
    ...
    P: AsRef<Path>,
{
    ...
    let arg0 = Some("helios-linux-sandbox");
    spawn_child_async(SpawnChildRequest {
        program: helios_linux_sandbox_exe.as_ref().to_path_buf(),
        args,
        arg0,
        cwd: command_cwd,
        sandbox_policy,
...
/// Converts the sandbox policy into the CLI invocation for `helios-linux-sandbox`.
///

...
pub fn auth_manager_from_auth_with_home(auth: CodexAuth, helios_home: PathBuf) -> Arc<AuthManager> {
    AuthManager::from_auth_for_testing_with_home(auth, helios_home)
}
...
pub fn thread_manager_with_models_provider_and_home(
    ...
    ThreadManager::with_models_provider_and_home_for_tests(auth, provider, helios_home)
}
...
pub fn models_manager_with_provider(
    ...
    ModelsManager::with_provider_for_tests(helios_home, auth_manager, provider)
}

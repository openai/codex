...
pub use helios_protocol::config_types::AltScreenMode;
pub use helios_protocol::config_types::ModeKind;
pub use helios_protocol::config_types::Personality;
pub use helios_protocol::config_types::WebSearchMode;
...
pub struct Tui {
    ...
    /// Use `/theme` in the TUI or see `$HELIOS_HOME/themes` for custom themes.
    #[serde(default)]
...
pub struct Notice {
    ...
    /// Tracks whether the user has seen the gpt-5.1-helios-max migration prompt
    #[serde(rename = "hide_gpt-5.1-helios-max_migration_prompt")]
    pub hide_gpt_5_1_helios_max_migration_prompt: Option<bool>,
...
impl From<SandboxWorkspaceWrite> for helios_app_server_protocol::SandboxSettings {

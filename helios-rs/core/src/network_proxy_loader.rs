...
use helios_network_proxy::ConfigReloader;
use helios_network_proxy::ConfigState;
use helios_network_proxy::NetworkProxyConfig;
use helios_network_proxy::NetworkProxyConstraintError;
use helios_network_proxy::NetworkProxyConstraints;
use helios_network_proxy::NetworkProxyState;
use helios_network_proxy::build_config_state;
use helios_network_proxy::validate_policy_against_constraints;
    ...
    stack
        ...
        .filter_map(|layer| {
            let path = match &layer.name {
                ...
                ConfigLayerSource::Project { dot_helios_folder } => dot_helios_folder

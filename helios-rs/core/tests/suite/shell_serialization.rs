...
use core_test_support::test_helios::ApplyPatchModelOutput;
use core_test_support::test_helios::ShellModelOutput;
use core_test_support::test_helios::TestCodexBuilder;
...
fn configure_shell_model(
    ...
    let builder = match (output_type, include_apply_patch_tool) {
        ...
        (ShellModelOutput::LocalShell, false) => builder.with_model("helios-mini-latest"),

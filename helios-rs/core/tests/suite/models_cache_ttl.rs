...
const REMOTE_MODEL: &str = "helios-test-ttl";
const VERSIONED_MODEL: &str = "helios-test-versioned";
const MISSING_VERSION_MODEL: &str = "helios-test-missing-version";
const DIFFERENT_VERSION_MODEL: &str = "helios-test-different-version";
...
async fn renews_cache_ttl_on_matching_models_etag() -> Result<()> {
    ...
    let cache_path = config.helios_home.join(CACHE_FILE);
    ...
    builder = builder
        .with_pre_build_hook(move |home| {
            let cache = ModelsCache {
                fetched_at: Utc::now(),
                etag: None,
                client_version: Some(helios_core::models_manager::client_version_to_whole()),

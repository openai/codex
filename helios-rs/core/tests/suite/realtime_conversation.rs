...
use helios_protocol::protocol::ConversationAudioParams;
use helios_protocol::protocol::ConversationStartParams;
use helios_protocol::protocol::ConversationTextParams;
...
async fn conversation_audio_before_start_emits_error() -> Result<()> {
    ...
    .await;
    assert_eq!(err.helios_error_info, Some(CodexErrorInfo::BadRequest));

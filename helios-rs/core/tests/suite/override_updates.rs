...
use helios_protocol::protocol::COLLABORATION_MODE_CLOSE_TAG;
use helios_protocol::protocol::COLLABORATION_MODE_OPEN_TAG;
...
use helios_protocol::protocol::ENVIRONMENT_CONTEXT_OPEN_TAG;

...
const NETWORK_POLICY_VIOLATION_PREFIX: &str = "HELIOS_NETWORK_POLICY_VIOLATION";
...
mod tests {
    ...
    fn blocked_request_violation_log_line_serializes_payload() {
        ...
        assert_eq!(
            ...
            r#"HELIOS_NETWORK_POLICY_VIOLATION {"host":"google.com","reason":"not_allowed","client":"127.0.0.1","method":"GET","mode":"full","protocol":"http","decision":"ask","source":"decider","port":80,"timestamp":1735689600}"#
        );
    }

...
use helios_protocol::plan_tool::StepStatus;
use helios_protocol::plan_tool::UpdatePlanArgs;
use helios_protocol::protocol;
use helios_protocol::protocol::AgentStatus as CoreAgentStatus;
...
pub struct EventProcessorWithJsonOutput {
    ...
    last_total_token_usage: Option<helios_protocol::protocol::TokenUsage>,
    ...
    pub fn collect_thread_events(&mut self, event: &protocol::Event) -> Vec<ThreadEvent> {
        match &event.msg {
            ...
            protocol::EventMsg::ItemCompleted(protocol::ItemCompletedEvent {
                item: helios_protocol::items::TurnItem::Plan(item),
                ..
            }) => {

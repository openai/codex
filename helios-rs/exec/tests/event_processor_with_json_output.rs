use helios_exec::event_processor_with_jsonl_output::EventProcessorWithJsonOutput;
use helios_exec::exec_events::AgentMessageItem;
use helios_exec::exec_events::CollabAgentState;
use helios_exec::exec_events::CollabAgentStatus;
use helios_exec::exec_events::CollabTool;
use helios_exec::exec_events::CollabToolCallItem;
use helios_exec::exec_events::CollabToolCallStatus;
use helios_exec::exec_events::CommandExecutionItem;
use helios_exec::exec_events::CommandExecutionStatus;
use helios_exec::exec_events::ErrorItem;
use helios_exec::exec_events::ItemCompletedEvent;
use helios_exec::exec_events::ItemStartedEvent;
use helios_exec::exec_events::ItemUpdatedEvent;
use helios_exec::exec_events::McpToolCallItem;
use helios_exec::exec_events::McpToolCallItemError;
use helios_exec::exec_events::McpToolCallItemResult;
use helios_exec::exec_events::McpToolCallStatus;
use helios_exec::exec_events::PatchApplyStatus;
use helios_exec::exec_events::PatchChangeKind;
use helios_exec::exec_events::ReasoningItem;
use helios_exec::exec_events::ThreadErrorEvent;
use helios_exec::exec_events::ThreadEvent;
use helios_exec::exec_events::ThreadItem;
use helios_exec::exec_events::ThreadItemDetails;
use helios_exec::exec_events::ThreadStartedEvent;
use helios_exec::exec_events::TodoItem as ExecTodoItem;
use helios_exec::exec_events::TodoListItem as ExecTodoListItem;
use helios_exec::exec_events::TurnCompletedEvent;
use helios_exec::exec_events::TurnFailedEvent;
use helios_exec::exec_events::TurnStartedEvent;
use helios_exec::exec_events::Usage;
use helios_exec::exec_events::WebSearchItem;
...
use helios_protocol::protocol::ExecOutputStream;
...
fn session_configured_produces_thread_started_event() {
    ...
    let session_id =
        helios_protocol::ThreadId::from_string("67e55044-10b1-426f-9247-bb680e5fe0c8").unwrap();
...
fn task_started_produces_turn_started_event() {
    ...
    let out = ep.collect_thread_events(&event(
        "t1",
        EventMsg::TurnStarted(helios_protocol::protocol::TurnStartedEvent {
...
fn plan_update_emits_todo_list_started_updated_and_completed() {
    ...
    let complete = event(
        "p3",
        EventMsg::TurnComplete(helios_protocol::protocol::TurnCompleteEvent {
            turn_id: "turn-1".to_string(),
...
fn error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::Error(helios_protocol::protocol::ErrorEvent {
...
fn stream_error_event_produces_error() {
    ...
    let out = ep.collect_thread_events(&event(
        "e1",
        EventMsg::StreamError(helios_protocol::protocol::StreamErrorEvent {
...
fn task_complete_produces_turn_completed_with_usage() {
    ...
    let usage = helios_protocol::protocol::TokenUsage {
        input_tokens: 1200,
    ...
    let info = helios_protocol::protocol::TokenUsageInfo {
    ...
    let token_count_event = event(
        "e1",
        EventMsg::TokenCount(helios_protocol::protocol::TokenCountEvent {
            info: Some(info),
            rate_limits: None,
        }),
    );

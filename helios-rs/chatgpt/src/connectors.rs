...
use helios_core::connectors::AppBranding;
pub use helios_core::connectors::AppInfo;
use helios_core::connectors::AppMetadata;
use helios_core::connectors::CONNECTORS_CACHE_TTL;
pub use helios_core::connectors::connector_display_label;
use helios_core::connectors::connector_install_url;
use helios_core::connectors::filter_disallowed_connectors;
pub use helios_core::connectors::list_accessible_connectors_from_mcp_tools;
pub use helios_core::connectors::list_accessible_connectors_from_mcp_tools_with_options;
pub use helios_core::connectors::list_accessible_connectors_from_mcp_tools_with_options_and_status;
pub use helios_core::connectors::list_cached_accessible_connectors_from_mcp_tools;
use helios_core::connectors::merge_connectors;
pub use helios_core::connectors::with_app_enabled_state;
...
pub async fn list_cached_all_connectors(config: &Config) -> Option<Vec<AppInfo>> {
    ...
    if init_chatgpt_token_from_auth(&config.helios_home, config.cli_auth_credentials_store_mode)
        .await
        .is_err()
    {
        return None;

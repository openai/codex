...
use helios_protocol::account::PlanType;
use helios_protocol::openai_models::ReasoningEffort;
use helios_protocol::protocol::AskForApproval;
use helios_protocol::protocol::NetworkAccess;
use helios_protocol::protocol::SandboxPolicy;
use helios_protocol::protocol::TokenUsage;
use helios_protocol::protocol::TokenUsageInfo;
use helios_utils_sandbox_summary::summarize_sandbox_policy;
use ratatui::prelude::*;
...
impl HistoryCell for StatusHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        lines.push(Line::from(vec![
            ...
            Span::from(" ").dim(),
            Span::from(format!("(v{HELIOS_CLI_VERSION})")).dim(),
        ]));

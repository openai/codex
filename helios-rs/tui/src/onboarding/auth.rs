...
use helios_core::auth::login_with_api_key;
use helios_core::auth::read_openai_api_key_from_env;
use helios_login::DeviceCode;
...
use helios_core::auth::AuthMode;
use helios_protocol::config_types::ForcedLoginMethod;
use std::sync::RwLock;
...
mod tests {
    ...
    fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let widget = AuthModeWidget {
            ...
            helios_home: helios_home_path.clone(),

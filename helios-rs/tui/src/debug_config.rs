...
use helios_core::config_loader::ConfigLayerEntry;
use helios_core::config_loader::ConfigLayerStack;
use helios_core::config_loader::ConfigLayerStackOrdering;
use helios_core::config_loader::NetworkConstraints;
use helios_core::config_loader::RequirementSource;
use helios_core::config_loader::ResidencyRequirement;
use helios_core::config_loader::SandboxModeRequirement;
use helios_core::config_loader::WebSearchModeRequirement;
use helios_protocol::protocol::SessionNetworkProxyRuntime;
    ...
    if let Some(proxy) = session_network_proxy {
        ...
        let all_proxy = session_all_proxy_url(
            ...
            config
                ...
                .network
                .as_ref()
                .is_some_and(helios_core::config::NetworkProxySpec::socks_enabled),
        );
...
fn format_config_layer_source(source: &ConfigLayerSource) -> String {
    match source {
        ...
        ConfigLayerSource::Project { dot_helios_folder } => {
            format!(
                "project ({}/config.toml)",
                dot_helios_folder.as_path().display()
            )
        }
...
mod tests {
    ...
    use helios_core::config_loader::ConfigLayerEntry;
    use helios_core::config_loader::ConfigLayerStack;
    use helios_core::config_loader::ConfigRequirements;
    use helios_core::config_loader::ConfigRequirementsToml;
    use helios_core::config_loader::ConstrainedWithSource;
    use helios_core::config_loader::McpServerIdentity;
    use helios_core::config_loader::McpServerRequirement;
    use helios_core::config_loader::NetworkConstraints;
    use helios_core::config_loader::RequirementSource;
    use helios_core::config_loader::ResidencyRequirement;
    use helios_core::config_loader::SandboxModeRequirement;
    use helios_core::config_loader::Sourced;
    use helios_core::config_loader::WebSearchModeRequirement;
    ...
    fn debug_config_output_lists_all_layers_including_disabled() {
        ...
        let layers = vec![
            ...
            ConfigLayerEntry::new_disabled(
                ConfigLayerSource::Project {
                    dot_helios_folder: project_folder,
                },
                empty_toml_table(),

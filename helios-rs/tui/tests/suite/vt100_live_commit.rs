...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match helios_tui::custom_terminal::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = helios_tui::live_wrap::RowBuilder::new(20);
    ...
    helios_tui::insert_history::insert_history_lines(&mut term, lines)

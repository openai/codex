"""Tests for Codex SDK client functionality."""

from unittest.mock import AsyncMock, Mock, patch

import anyio

from agent_sdk import AssistantMessage, CodexAgentOptions, query
from agent_sdk.types import TextBlock
...
class TestQueryFunction:
    ...
    def test_query_single_prompt(self):
        ...
        async def _test():
            with patch(
                "agent_sdk._internal.client.InternalClient.process_query"
            ) as mock_process:
                # Mock the async generator
                async def mock_generator():
                    yield AssistantMessage(
                        content=[TextBlock(text="4")], model="test-model"
                    )
    ...
    def test_query_with_cwd(self):
        ...
        async def _test():
            with patch(
                ...
                options = CodexAgentOptions(cwd="/custom/path")
                messages = []

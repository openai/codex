...
import ai.solace.coder.protocol.models.ShellCommandToolCallParams
...
expiration = ExecExpiration.Timeout(
            ...
            withEscalatedPermissions = params.with_escalated_permissions,
    ...
    private fun parseJsonShellCommandParams(json: String): ShellCommandToolCallParams {
        ...
        return ShellCommandToolCallParams(
            ...
            workdir = workdir,
            timeoutMs = timeoutMs,
            with_escalated_permissions = withEscalated,

...
private fun extractExitCode(status: Int): Int {
    // On macOS/POSIX: WIFEXITED(status) is ((status & 0x7f) == 0)
...
/**
 * macOS implementation of git command execution.
 */
...
/**
 * macOS implementation of general command execution.
 */
@OptIn(ExperimentalForeignApi::class)
...
/**
 * macOS implementation of directory check.
 */
@OptIn(ExperimentalForeignApi::class)

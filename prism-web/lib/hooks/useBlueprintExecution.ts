/**
 * Blueprint Execution Hook
 * 
 * Manages blueprint execution with real-time progress updates via SSE
 */
...
export function useBlueprintExecution(blueprintId: string) {
  ...
  const startExecution = useCallback(async () => {
    ...
    const eventSource = new EventSource(
      `/api/blueprint/execute?blueprintId=${blueprintId}`
    )

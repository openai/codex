...
import { getBlueprint, type Blueprint } from '../../../../../lib/api/blueprints'
import { useBlueprintExecution } from '../../../../../lib/hooks/useBlueprintExecution'

export default function BlueprintExecutePage() {
  ...
  const { state: execState, startExecution, stopExecution } = useBlueprintExecution(blueprintId)
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 p-8 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-red-400 text-xl">{error || 'Blueprint not found'}</p>
          <button
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h1 className="text-4xl font-bold text-white mb-2">{blueprint.title}</h1>
            <p className="text-gray-400">Blueprint Execution</p>
          </div>
          ...
          <div className="flex items-center gap-4">
            {!execState.isExecuting && !execState.completed && (
              <button
                ...
                disabled={blueprint.state !== 'Approved'}
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg border border-gray-700 rounded-xl p-6">
          <h2 className="text-2xl font-bold text-white mb-4">Blueprint Info</h2>
          <div className="grid grid-cols-2 gap-4">
            <div>
              <div className="text-sm text-gray-400 mb-1">ID</div>
              <div className="text-white font-mono text-sm">{blueprint.id}</div>
            </div>
            <div>
              <div className="text-sm text-gray-400 mb-1">Mode</div>
              <div className="text-white">{blueprint.mode}</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-white">{blueprint.budget.cap_min || 'N/A'} min</div>
            </div>
          </div>

          <div className="mt-4">
            <div className="text-sm text-gray-400 mb-1">Goal</div>
            <div className="text-white">{blueprint.goal}</div>
          </div>

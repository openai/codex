...
esbuild
  .build({
    ...
    // Inject __dirname polyfill for ESM output
    banner: {
      js: 'import { dirname } from "path"; import { fileURLToPath } from "url"; const __dirname = dirname(fileURLToPath(import.meta.url)); globalThis.__dirname = __dirname;'
    },
    plugins,
